...
class NearbyContainerViewController: UIViewController, CarbonTabSwipeNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        titles = ["All", "Swimming", "Tuition", "Dance", "Kids Service"]
    ...
    func carbonTabSwipeNavigation(_ carbonTabSwipeNavigation: CarbonTabSwipeNavigation, viewControllerAt index: UInt) -> UIViewController {
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "NearByViewController") as! NearByViewController
        vc.type = Int(index)
        return vc
